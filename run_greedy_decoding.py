...
def main():
    ...
    experiment_name = f'greedy_sentences_{timestamp}'
    
    # Default arguments for greedy decoding with sentence-based answers
    # Sentence prompt options: 'default', 'chat', 'sentence', 'detailed'
    ...
    # - 'detailed': "Provide a detailed, well-structured answer... (most detailed)"
    cmd = [
    ...
    print(f"This will generate single, sentence-based answers using greedy decoding...")
    print(f"Experiment name: {experiment_name}")
    print(f"Prompt type: detailed (sentence-based answers)")
